...
const onScroll = () => {
  ...
  slider.style.transform = `translateX(-${scrollPosition / 65}%)`; // Adjust the divisor to control speed
  reverseSlider.style.transform = `translateX(-${scrollPosition / 45}%)`; // Adjust the divisor to control speed
};
