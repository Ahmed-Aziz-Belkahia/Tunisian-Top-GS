  ...
  function renderInnerContent$4(innerProps) {
    return createElement(
      ...
      createElement(
        ...
        createElement('div', { className: 'fc-task-text-box' }, createElement('span', { className: 'fc-task-text' }, innerProps.event.task), ''),
        createElement('div', { className: 'fc-task-text-box' }, createElement('span', { className: 'fc-task-text' }, innerProps.event.hours), ''),
      ),
