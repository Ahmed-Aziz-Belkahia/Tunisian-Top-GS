    ...
    datasets: [
      {
        ...
        highlightStroke: CrocsAdminConfig.primary,
      ...
      },
      {
        ...
        highlightStroke: CrocsAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: CrocsAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    },
    {
      ...
      highlight: CrocsAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
    ...
    datasets: [
      {
        ...
        strokeColor: CrocsAdminConfig.primary,
        pointColor: CrocsAdminConfig.primary,
      ...
      },
      {
        ...
        strokeColor: CrocsAdminConfig.secondary,
        pointColor: CrocsAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: CrocsAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        strokeColor: CrocsAdminConfig.primary,
        pointColor: CrocsAdminConfig.primary,
        pointStrokeColor: CrocsAdminConfig.primary,
        pointHighlightFill: CrocsAdminConfig.primary,
