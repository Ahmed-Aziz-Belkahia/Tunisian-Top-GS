  ...
  var morris_chart = {
    init: function () {
      Morris.Area({
        ...
        ykeys: ["y", "z"],
        labels: ["Y", "Z"],
        lineColors: [CrocsAdminConfig.secondary, CrocsAdminConfig.primary],
      }),
        Morris.Line({
          ...
          xkey: "y",
          ykeys: ["a", "b"],
          lineColors: [CrocsAdminConfig.primary, CrocsAdminConfig.secondary],
        ...
        Morris.Bar({
          ...
          ykeys: ["y"],
          labels: ["Y"],
          barColors: [CrocsAdminConfig.primary],
        }),
        $(function () {
          var b = [
            {
          ...
          Morris.Bar({
            ...
            data: b,
            barColors: [CrocsAdminConfig.primary, CrocsAdminConfig.secondary],
            xkey: "period",
        ...
        $(function () {
          ...
          window.m = Morris.Line({
            ...
            labels: ["sin(x)"],
            parseTime: !1,
            lineColors: [CrocsAdminConfig.primary],
