        ...
        ajaxRequest("POST", "/get-video/", { videoId: videoId }, function (response) {
            if (response.success && response.video) {
                ...
                if (response.video.vimeo_url) {
                    lesson_video_container.innerHTML = '<div style="padding:56.5% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/980078415?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Shut up your mouth Obama interview during #AMF14 in Dubai"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>';
