        ...
        ajaxRequest("POST", "/get-video/", { videoId: videoId }, function (response) {
            if (response.success && response.video) {
                ...
                if (response.video.vimeo_url) {
                    lesson_video_container.innerHTML = '<iframe src="https://player.vimeo.com/video/980078415?autoplay=0&badge=0&byline=0&title=0" width="100%" height="100%" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>';
