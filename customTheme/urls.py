...
urlpatterns = [
    ...
    path('contact-submissions', views.contact_submissions, name="admin-contact-submissions"),
    ...
    path('onboarding-tracks', views.onboarding_tracks, name="admin-onboarding-tracks"),
    ...
    path('contact-submissions-add/<int:id>', views.contact_submissions_add, name="admin-contact-submissions-add"),
    ...
    path('onboarding-tracks-add/<int:id>', views.onboarding_tracks_add, name="admin-onboarding-tracks-add"),
    ...
    path('contact-submissions-delete/<int:id>', views.contact_submissions_delete, name="admin-contact-submissions-delete"),
    ...
    path('onboarding-tracks-delete/<int:id>', views.onboarding_tracks_delete, name="admin-onboarding-tracks-delete"),
