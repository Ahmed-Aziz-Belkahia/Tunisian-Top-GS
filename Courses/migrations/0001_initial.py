    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requierment', models.CharField(choices=[('None', 'None'), ('previous', 'Previous'), ('hard', 'Hard Close')], default='None', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=0)),
                ('title', models.CharField(max_length=255)),
                ('vimeo_url', models.URLField(blank=True, max_length=1000, null=True)),
