...
class Course(models.Model):
    ...
    professor = models.ForeignKey('Users.Professor', on_delete=models.SET_NULL, related_name='courses', null=True, blank=True)
...
class Level(models.Model):
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, related_name='admin_levels', blank=True, null=True)
...
class Module(models.Model):
    ...
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, related_name='admin_modules', null=True, blank=True)
    level = models.ForeignKey(Level, on_delete=models.SET_NULL, related_name='modules', null=True, blank=True)
    title = models.CharField(max_length=255)
...
class Video(models.Model):
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, related_name='admin_videos', null=True, blank=True)
    module = models.ForeignKey(Module, on_delete=models.SET_NULL, related_name='videos', null=True, blank=True)
    index = models.IntegerField(default=0)
    title = models.CharField(max_length=255)
...
class Quiz(models.Model):
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, related_name='admin_quizzes', null=True, blank=True)
    video = models.ForeignKey(Video, on_delete=models.SET_NULL, related_name='quizzes', null=True, blank=True)
    question = models.TextField()
    answer = models.ForeignKey("Courses.QuizOption", on_delete=models.SET_NULL, blank=True, null=True, related_name='quiz_answer')

    def __str__(self):
        return self.question

class QuizOption(models.Model):
    quiz = models.ForeignKey(Quiz, on_delete=models.SET_NULL, related_name='options', null=True, blank=True)
...
class Exam(models.Model):
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, related_name='exams', blank=True, null=True)
    name = models.CharField(max_length=255)
    quizzes = models.ManyToManyField(Quiz)


class UserCourseProgress(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, related_name='usercourseprogression', null=True, blank=True)
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, null=True, blank=True)
