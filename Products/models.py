...
class SubImage(models.Model):
    product = models.ForeignKey(Product, on_delete=models.PROTECT, related_name='sub_images', null=True, blank=True)
...
class Deal(models.Model):
    product = models.ForeignKey(Product, on_delete=models.PROTECT, related_name='deal', null=True, blank=True)
...
class Review(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.PROTECT, blank=True, null=True, related_name="reviews")
